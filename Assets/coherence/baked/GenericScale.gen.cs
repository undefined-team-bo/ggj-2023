...
namespace Coherence.Generated
{
	...
	public struct GenericScale : ICoherenceComponentData
	{
		...
		public static (GenericScale, uint, uint?) DeserializeArchetypeCube_2f37b1be90c58714f91aba02c042dfd9_GenericScale_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new GenericScale();
			if (bitStream.ReadMask())
		...
		public static (GenericScale, uint, uint?) DeserializeArchetypeCube__char_32_Variant_e8d6920402569dd47b477052885e156b_GenericScale_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new GenericScale();
			if (bitStream.ReadMask())
